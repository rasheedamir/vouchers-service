...
public class ApiError implements Serializable {
    ...
    ApiError(String type, String title, String status, String detail, String instance) {
        this.type = type;
        this.title = title;
        this.status = status;
        this.detail = detail;
    ...
    public void addFieldError(String objectName, String field, String message) {
        ApiFieldError apiFieldError = new ApiFieldError(objectName, field, message);
        fieldErrors.add(apiFieldError);
    }
}
